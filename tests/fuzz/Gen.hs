...
-- Non-ASCII literals include CASED letters since Data.Char went
-- Unicode (string milestone F3: classification and case tables are
-- generated from the oracle GHC itself, so toUpper/isUpper/... on
-- any code point agree by construction).
safeChars :: [Char]
safeChars = ['a' .. 'z'] ++ ['A' .. 'Z'] ++ ['0' .. '9'] ++ " "
            ++ "\28450\20013\9733\128077\955\923\228\196\233\1073"

safeWords :: [String]
safeWords = ["fuzz", "oracle", "Ada", "graph", "x1 y2", "thunk", "",
             "\28450\23383", "x\9733y", "\128077ok",
             "\955\945\956\946\948\945", "gr\252\223e", "\1073\1099"]
