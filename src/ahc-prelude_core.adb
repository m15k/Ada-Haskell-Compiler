...
package body AHC.Prelude_Core is
   ...
   begin
      ...
      begin
         ...
         BP ("primCatch", "ahc_prim_catch");
         BP ("primThrowIO", "ahc_prim_throw_io");
         BP ("primThrow", "ahc_prim_throw");
         BP ("primEvaluate", "ahc_prim_evaluate");
         BP ("primExcKind", "ahc_prim_exc_kind");
         BP ("primExcMessage", "ahc_prim_exc_message");
         BP ("primExcCode", "ahc_prim_exc_code");
         BP ("primExcIO", "ahc_prim_exc_io");
         BP ("primExcErrorCall", "ahc_prim_exc_error_call");
         BP ("primExcArith", "ahc_prim_exc_arith");
         BP ("primExcFromIO", "ahc_prim_exc_from_io");
         BP ("primExcExit", "ahc_prim_exc_exit");
         BP ("primMkIOError", "ahc_prim_mk_ioerror");
         BP ("primIoeType", "ahc_prim_ioe_type");
         ...
         BP ("primIsUpperU", "ahc_prim_uc_is_upper");
         BP ("primIsLowerU", "ahc_prim_uc_is_lower");
         BP ("primIsAlphaU", "ahc_prim_uc_is_alpha");
         BP ("primIsAlphaNumU", "ahc_prim_uc_is_alnum");
         BP ("primIsPunctuationU", "ahc_prim_uc_is_punct");
         BP ("primIsSpaceU", "ahc_prim_uc_is_space");
         BP ("primToUpperU", "ahc_prim_uc_to_upper");
         BP ("primToLowerU", "ahc_prim_uc_to_lower");
      end;
